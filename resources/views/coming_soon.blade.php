...
<head>
	...
	<title>FundsForLife - Coming Soon</title>
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="{{asset('fundsforlife/images/logo.png')}}">
			    				
			<h1 id="cspio-headline">Coming Soon!</h1>			    				
			
			<div id="cspio-description">Get ready, Something really cool is coming!</div>			    				
			
			<form id="cspio-form" action="{{url('notify-me')}}" method="post">
			...
			<div id="cspio-credit">
					<span>Created by <a target="_blank" href="https://www.fundsforlife.com.ng">FundsForLife</a>
				</span></div>
